...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError(`Client Error: ${err.message || err.code || "Unknown error"}`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-sm">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-xl font-bold text-zinc-100">HarmFilter</h1>
          ...
          <button
            ...
            type="button"
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-100 font-medium text-sm hover:bg-zinc-750 hover:border-zinc-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
